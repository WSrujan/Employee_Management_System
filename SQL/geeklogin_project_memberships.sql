...
CREATE TABLE `project_memberships` (
  ...
  CONSTRAINT `project_memberships_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `accounts` (`id`),
  CONSTRAINT `project_memberships_ibfk_2` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`)
...
INSERT INTO `project_memberships` VALUES (1000,1),(1001,1);
